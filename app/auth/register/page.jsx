...
export default function RegisterPage() {
    ...
    const getPasswordStrength = () => {
        ...
        if (password.length < 8) return { strength: 2, text: 'Sedang', color: 'text-yellow-500' }
            ...
            >
                <div className="bg-white rounded-2xl shadow-prayer border border-gray-100 overflow-hidden">
                    ...
                    <div className="bg-gradient-islamic p-6 text-white text-center">
                        ...
                        <h1 className="text-2xl font-bold mb-2">Bergabung dengan Nayea.id</h1>
                        <p className="opacity-90">Mulai berbelanja fashion islami terpercaya</p>
                    </div>
                    ...
                    <div className="p-6">
                                    ...
                                    <div className="mt-2">
                                        <div className="flex items-center gap-2">
                                            <div className="flex-1 bg-gray-200 rounded-full h-2">
                                                <div
                                                    className={`h-2 rounded-full transition-all duration-300 ${passwordStrength.strength === 1 ? 'w-1/3 bg-red-500' :
                            ...
                            <div className="form-group">
                                <label className="flex items-start">
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className="rounded border-gray-300 text-islamic-green-600 focus:ring-islamic-green-500 mt-1"
                                    />
                                    <span className="ml-2 text-sm text-gray-600">
                                        Saya menyetujui{' '}
                                        <Link href="/terms" className="text-islamic-green-600 hover:text-islamic-green-700">
                                            Syarat & Ketentuan
                                        </Link>{' '}
                                        dan{' '}
                                        <Link href="/privacy" className="text-islamic-green-600 hover:text-islamic-green-700">
                                            Kebijakan Privasi
                                        </Link>
                                    </span>
                                </label>
                        ...
                        <p className="text-center text-sm text-gray-600 mt-6">
                            Sudah punya akun?{' '}
                            <Link href="/auth/login" className="text-islamic-green-600 hover:text-islamic-green-700 font-semibold">
                                Masuk di sini
                            </Link>
                        </p>
                    </div>
                ...
                >
                    <p className="arabic-text text-lg mb-2">وَقُلِ اعْمَلُوا فَسَيَرَى اللَّهُ عَمَلَكُمْ</p>
                    <p className="text-sm italic">"Dan katakanlah: Bekerjalah, maka Allah akan melihat pekerjaanmu"</p>
                </motion.div>
            </motion.div>
        </div>
    )
